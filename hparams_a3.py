...
GROUPS = {
    ...
    "IDS_EXP1_BASE": {"HIDDEN": 128, "MAX_CL_EDGES": 8192, "DROPEDGE_P": 0.1, "CL_LOSS_WEIGHT": 0.1, "LR": 0.001},
    "IDS_EXP2_MAXCL": {"HIDDEN": 128, "MAX_CL_EDGES": 16384, "DROPEDGE_P": 0.1, "CL_LOSS_WEIGHT": 0.1, "LR": 0.001},
    "IDS_EXP3_SMALLH": {"HIDDEN": 64, "MAX_CL_EDGES": 16384, "DROPEDGE_P": 0.1, "CL_LOSS_WEIGHT": 0.1, "LR": 0.001},
    "IDS_EXP4_NOCL": {"HIDDEN": 128, "MAX_CL_EDGES": 8192, "DROPEDGE_P": 0.1, "CL_LOSS_WEIGHT": 0.0, "LR": 0.001},
    "IDS_EXP5_DROP": {"HIDDEN": 128, "MAX_CL_EDGES": 8192, "DROPEDGE_P": 0.3, "CL_LOSS_WEIGHT": 0.1, "LR": 0.001},
    ...
    "NB_EXP1_BASE": {"HIDDEN": 128, "SEQ_LEN": 10, "KERNELS": [1, 3, 5, 7], "DROPEDGE_P": 0.2, "CL_LOSS_WEIGHT": 0.2, "LR": 0.001},
    "NB_EXP2_LONGK": {"HIDDEN": 128, "SEQ_LEN": 10, "KERNELS": [1, 3, 5, 7, 9, 11], "DROPEDGE_P": 0.2, "CL_LOSS_WEIGHT": 0.2, "LR": 0.001},
    "NB_EXP3_STRONG": {"HIDDEN": 128, "SEQ_LEN": 10, "KERNELS": [1, 3, 5, 7, 9, 11], "DROPEDGE_P": 0.3, "CL_LOSS_WEIGHT": 0.3, "LR": 0.001},
    "NB_EXP4_NOATT": {"HIDDEN": 128, "SEQ_LEN": 10, "KERNELS": [1], "DROPEDGE_P": 0.2, "CL_LOSS_WEIGHT": 0.2, "LR": 0.001},
    "NB_EXP5_LONGSEQ": {"HIDDEN": 128, "SEQ_LEN": 20, "KERNELS": [1, 3, 5, 7], "DROPEDGE_P": 0.2, "CL_LOSS_WEIGHT": 0.2, "LR": 0.001, "BATCH_SIZE": 8, "ACCUM_STEPS": 4},

    "IS_EXP1_BASE": {"HIDDEN": 64, "HEADS": 4, "DROPEDGE_P": 0.1, "CL_LOSS_WEIGHT": 0.1, "LR": 0.0005, "PATIENCE": 15, "MAX_CL_EDGES": 2048},
    "IS_EXP2_TINY": {"HIDDEN": 32, "HEADS": 4, "DROPEDGE_P": 0.1, "CL_LOSS_WEIGHT": 0.1, "LR": 0.0005, "PATIENCE": 15, "MAX_CL_EDGES": 2048},
    "IS_EXP3_REG": {"HIDDEN": 32, "HEADS": 4, "DROPEDGE_P": 0.3, "CL_LOSS_WEIGHT": 0.2, "LR": 0.0005, "PATIENCE": 15, "MAX_CL_EDGES": 2048},
    "IS_EXP4_NOCL": {"HIDDEN": 32, "HEADS": 4, "DROPEDGE_P": 0.1, "CL_LOSS_WEIGHT": 0.0, "LR": 0.0005, "PATIENCE": 15, "MAX_CL_EDGES": 2048},
